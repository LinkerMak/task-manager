...
public final class ExceptionMessages {
    ...
    public static final String DATA_INTEGRITY_VIOLATION_MESSAGE = "Operation cannot be completed because related data was changed or deleted.";

    public static final String UNKNOWN_ERROR_MESSAGE = "Unknown error";

    public static final String INVALID_SORT_FIELD_MESSAGE = "Invalid sort field: ";
